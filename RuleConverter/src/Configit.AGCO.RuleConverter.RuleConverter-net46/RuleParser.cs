...
namespace Configit.AGCO.Prototype.RuleConverter {
  public class RuleParser {
    ...
    public RuleParser( Dictionary<string, string> hierarchy, ProductModel model ) {
      _parseUtils = new ParseUtils( hierarchy, model );
    }

    public List<ConvertedRule> ConvertRules( List<ExtractedRule> rules ) {
